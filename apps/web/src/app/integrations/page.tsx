...
export default function IntegrationsPage() {
  ...
  const [amazonMode, setAmazonMode] = useState<"oauth" | "manual">("oauth");
  ...
  function openConnect(channel: ChannelCatalogEntry) {
    if (channel.platform === "amazon") { setAmazonMode("oauth"); setOpen(true); return; }
